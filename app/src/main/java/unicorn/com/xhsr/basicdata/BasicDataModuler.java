package unicorn.com.xhsr.basicData;
...
public class BasicDataModuler {

    public void fetchBasicData() {
        getEquipment();
        getBuilding();
        getDepartment();
        getProcessMode();
    ...
    private void getProcessTimeLimit() {
    ...
    private void getEmergencyDegree() {
