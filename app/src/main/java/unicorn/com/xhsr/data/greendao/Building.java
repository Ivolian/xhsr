...
public class Building {
    ...
    public Building(String objectId, String name, int level, String fullName, int orderNo, String parentId) {
        this.objectId = objectId;
        this.name = name;
        this.level = level;
    ...
    public Building getParent() {
        ...
        if (parent__resolvedKey == null || parent__resolvedKey != __key) {
            ...
            Building parentNew = targetDao.load(__key);
            synchronized (this) {
                parent = parentNew;
    ...
    public List<Building> getChildren() {
        if (children == null) {
            ...
            BuildingDao targetDao = daoSession.getBuildingDao();
            List<Building> childrenNew = targetDao._queryBuilding_Children(objectId);
            synchronized (this) {
                if(children == null) {
